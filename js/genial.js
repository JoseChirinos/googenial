var Genial = function(){
	...
	this.init = function(){
		this.onSupportIE();
		this._genial = document.querySelectorAll('.genial');
		this.addEvent();
	}
	...
	this.onSupportIE = function(){
		Array.prototype.forEach||(Array.prototype.forEach=function(r,o){var t,n;if(null==this)throw new TypeError(" this is null or not defined");var i=Object(this),e=i.length>>>0;if("function"!=typeof r)throw new TypeError(r+" is not a function");for(arguments.length>1&&(t=o),n=0;n<e;){var f;n in i&&(f=i[n],r.call(t,f,n,i)),n++}})
	}
	...
	this.handlerLike = function(el){
		var data = JSON.parse(el.getAttribute('data-genial'));
		if(data.press == 0){
			data.press = 1;
	...
	this.unliked = function(el){
		...
		el.querySelector('.genial-smile .unliked').style.display = "block";
		el.querySelector('.genial-smile .liked').style.display = "none";
	}
}
...
(function(e){
	onSupportIE();
	var _genial = document.querySelectorAll('.genial');
	[].forEach.call(_genial,function(i){
		console.log(i);
	})
